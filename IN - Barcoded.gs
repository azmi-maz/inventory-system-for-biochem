function incomingStock() {
  ...
  if (finalArrayForVerification.length === 0) {
    ...
    ss.getSheetByName("Verification").getRange(getTblVerificationLastRow + 1, 1, finalArrayForVerification.length, finalArrayForVerification[0].length).setValues(finalArrayForVerification);
  }
